  ...
  return (
    <div className="sera-card" style={{ padding: 'var(--space-5)' }}>
      ...
      {formOpen && (
        <div
          style={{
            marginBottom: 14, padding: '14px', borderRadius: 'var(--radius-md)',
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
            <span className="sera-label" style={{ fontSize: 10 }}>На что</span>
              ...
              {(['all', 'service'] as const).map(v => (
                <button
                  ...
                  style={{
                    ...
                    background: form.scope === v ? 'var(--ink)' : 'var(--card)',
                    color: form.scope === v ? 'var(--card)' : 'var(--ink-2)',
                    border: '1px solid var(--line)',
                  }}
                >
                  {v === 'all' ? 'На всё' : 'На услугу'}
                </button>
              ))}
            </div>
            {form.scope === 'service' && (
          ...
          <div style={{ display: 'flex', gap: 6, alignItems: 'flex-end' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              <span className="sera-label" style={{ fontSize: 10 }}>Тип</span>
              <select
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 4, flex: 1 }}>
              <span className="sera-label" style={{ fontSize: 10 }}>Размер</span>
              <input
                type="number"
                min={0}
                ...
                style={{
                  height: 32, padding: '0 10px', borderRadius: 'var(--radius-sm)',
                  border: '1px solid var(--line)', background: 'var(--card)',
                  color: 'var(--ink)', fontSize: 12, width: '100%', boxSizing: 'border-box',
                }}
              />
            </div>
          </div>
          ...
          {/* Срок */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
            <span className="sera-label" style={{ fontSize: 10 }}>Срок</span>
            <div style={{ display: 'flex', gap: 6 }}>
              {(['forever', 'date', 'once'] as const).map(v => (
                <button
                  ...
                  style={{
                    ...
                    background: form.validMode === v ? 'var(--ink)' : 'var(--card)',
          ...
          <div style={{ display: 'flex', gap: 6 }}>
            <button
              ...
              className="sera-btn sera-btn--secondary sera-btn--sm flex-1"
            ...
            <button
              ...
              disabled={saving}
              className="sera-btn sera-btn--sera sera-btn--sm flex-[2]"
              style={{ height: 32, fontSize: 12 }}
            >
